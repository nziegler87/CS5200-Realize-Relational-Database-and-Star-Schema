...
```{sql connection=dbcon}
SELECT SFT.num_articles_published, SFT.num_articles_with_revisions
...
```{sql connection=dbcon}
SELECT SFT.num_articles_published, SFT.num_articles_with_revisions, SFT.avg_days_to_submission
FROM Summary_Fact_Table AS SFT
WHERE SFT.journal_id = 6 AND SFT.dim_year = 0 AND SFT.dim_quarter = 0;
```
