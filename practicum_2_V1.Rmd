...
![](Practicum2 - Star Schema.png "Practicum 2 - FTD") <https://lucid.app/lucidchart/5a835436-ec1a-461a-94d4-bd4d46ece96f/edit?viewport_loc=-4369%2C-3185%2C9062%2C7500%2CqFE4j-VncB.u&invitationId=inv_2685f3e2-beaf-4ddd-808d-a2ccd6c89094>
...
# TODO: There was no primary key, so I added one in the create table and the ERD...need to update this
# TODO: We can modify this (from practicum 1) to add in a pk - setDT(factTableDump.df, keep.rownames = TRUE)[]
...
![](Practicum2 - Star Schema.png "Practicum 2 - Summary Fact Table") <https://lucid.app/lucidchart/5a835436-ec1a-461a-94d4-bd4d46ece96f/edit?viewport_loc=-4369%2C-3185%2C9062%2C7500%2CqFE4j-VncB.u&invitationId=inv_2685f3e2-beaf-4ddd-808d-a2ccd6c89094>
...
```{sql connection=dbcon}
SELECT journal_id, avg_days_to_submission FROM Summary_Fact_Table
WHERE author_id = 0 AND dim_year = 0 AND dim_quarter = 0;
```
