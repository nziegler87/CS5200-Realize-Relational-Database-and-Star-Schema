...
head(fact_table.df)
```
## Create Statements for Fact and Dimension Tables
```{sql connection=dbcon}
...
CREATE TABLE DIM_Year (
  ...
  dim_year_description VARCHAR(200) NOT NULL,
...
CREATE TABLE DIM_Quarter (
  ...
  dim_quarter_description VARCHAR(200) NOT NULL,
...
CREATE TABLE DIM_Author (
  ...
  dim_author_last_name VARCHAR(200) NOT NULL,
  dim_author_fore_name VARCHAR(200) NOT NULL,
  dim_author_initials VARCHAR(200) NOT NULL,
...
CREATE TABLE DIM_Journal (
  ...
  dim_journal_name VARCHAR(200) NOT NULL,
  dim_journal_country VARCHAR(200) NOT NULL,
