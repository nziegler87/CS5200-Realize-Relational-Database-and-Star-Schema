...
# TODO: bringing in affiliation is causing many duplicates...do we clean or delete? Could try something like this: https://astrostatistics.psu.edu/su07/R/library/base/html/agrep.html
```
...
for ( i in 1:numArticles ){
  ...
  for ( i in 1:xmlSize(authorsResultSet) ){
   ...
   print(paste("last_name:", last_name, "| fore_name:", fore_name, "| initials:", initials, "| affiliation:", affiliation))
